...
public class EmpStatistics {
    ...
    private static void printDeptAvgSalary() {
        try {
            List<DeptSalaryStat> stats = EmpDAO.getDeptAvgSalaryStats();
    ...
    private static void printDeptAvgYears() {
        try {
            List<DeptYearsStat> stats = EmpDAO.getDeptAvgYearsStats();
    ...
    private static void printCountryAvgSalary() {
        try {
            List<CountrySalaryStat> stats = EmpDAO.getCountrySalaryStats();
    ...
    private static void printCountryPeopleCount() {
        try {
            List<CountryPeopleCountStat> stats = EmpDAO.getCountryPeopleCount();
    ...
    private static void printTop5LongestEmployees() {
        try {
            List<Emp> stats = EmpDAO.getTop5LongestEmployees();
