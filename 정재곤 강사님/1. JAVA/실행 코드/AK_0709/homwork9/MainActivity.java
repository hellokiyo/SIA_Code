...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        feeCalcbutton.setOnClickListener(v-> {
            ...
            // 할인율 계산   1인당 요금
            adultFeeOutput1.setText(Integer.toString(Fee(adultFee)));
            kidFeeOutput1.setText(Integer.toString(Fee(kidFee)));

            // 입장료 계산
            feeOutput.setText(Integer.toString(feeCalc(Fee(adultFee), Fee(kidFee))));

            //야간 할인
            if (hours > 17) {
                adultFee =12000;
                kidFee =4500;
                adultFeeOutput2.setText(Integer.toString(adultFee));
                kidFeeOutput2.setText(Integer.toString(kidFee));
            }
        });
